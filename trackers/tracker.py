# from trackers.cmc import * 不使用这个
...
class Tracker(object):
    ...
    def update(self, dets, dets_95,raw_frame):
        # ==============================================================================================================
        # Update frame id
        self.frame_id += 1
        ...
        warp_matrix = self.gmc.apply(raw_frame)
        apply_gmc(tracked_lost, warp_matrix)
        apply_gmc(new, warp_matrix)
    ...
    def update_without_detections(self,raw_frame):
        # Update frame id
        self.frame_id += 1
        ...
        # warp_matrix = self.cmc.get_warp_matrix()
        warp_matrix = self.gmc.apply(raw_frame)
        apply_gmc(self.tracks, warp_matrix)
